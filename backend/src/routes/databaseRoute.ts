...
import { ValidateDatabaseCheckBody, ValidateDatabaseEditBody, ValidateDatabaseNewBody } from "../middlewares/databaseMiddleware";
...
router.delete("/:connectionId", verifyToken, wrapAsync(databaseDestroy));
