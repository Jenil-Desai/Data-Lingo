...
interface LeftImageRightTextProps {
  imageSrc: string;
  title: string;
  description: string;
  primaryAction: {
...
function LeftImageRightText({ imageSrc, title, description, primaryAction, secondaryAction }: LeftImageRightTextProps) {
  return (
    <div className="flex flex-col md:flex-row items-center py-8 px-4 md:px-12 lg:px-24">
